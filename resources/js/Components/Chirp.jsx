...
export default function Chirp({ chirp }) {
    ...
    const { data, setData, patch, processing, reset, clearErrors, errors } =
        useForm({
        ...
        <div className="p-6 flex space-x-2">
            ...
            <div className="flex-1">
                <div className="flex justify-between items-center">
                    ...
                    {
                        // If the user is the owner of the chirp, show the dropdown
                        auth.user.id === chirp.user.id && (
                            <Dropdown>
                                ...
                                <Dropdown.Content>
                                    <button
                                        className="block w-full px-4 py-2 text-left text-sm leading-5 text-gray-300 hover:bg-gray-800 focus:bg-gray-100 transition duration-150 ease-in-out"
